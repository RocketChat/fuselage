  ...
  return (
    <FuselageProvider theme={theme}>
      <div style={{ minHeight: '100vh', background: theme === 'dark' ? '#1F2329' : '#F7F8FA' }}>
        ...
        <Section>
          <SectionTitle>Badges &amp; Tags (from @rocket.chat/fuselage)</SectionTitle>
          <Row>
            <Badge>12</Badge>
        ...
        <Section>
          <SectionTitle>MetricCards (from @rocket.chat/fuselage-ui)</SectionTitle>
          <Row>
        ...
        <Section>
          <SectionTitle>StatusCards (from @rocket.chat/fuselage-ui)</SectionTitle>
          <Row>
            <StatusCard title="Server" description="All operational" status="success" icon="checkmark-circled" count={3} />
            <StatusCard title="Database" description="High memory" status="warning" icon="warning" />
            <StatusCard title="Email" description="Connection failed" status="danger" icon="ban" count={1} />
          </Row>
        </Section>
        ...
        <Section>
          ...
          <RcxText fontFamily="$body" fontSize="$p1" color="$fontDefault">
            This text uses fuselage tokens via Tamagui. All packages share one theme.
          </RcxText>
        </Section>
