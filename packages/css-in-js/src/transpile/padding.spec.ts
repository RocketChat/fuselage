...
describe('padding-block', () => {
  it('supports padding-block', () => {
    expect(transpile('div', 'padding-block: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'padding-block: inherit;'))
      .toBe('div{padding-top:inherit;padding-bottom:inherit;}');
  });
});

describe('padding-block-start', () => {
  it('supports padding-block-start and padding-block-end', () => {
    expect(transpile('div', 'padding-block-start: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'padding-block-start: inherit;'))
      .toBe('div{padding-top:inherit;}');
  });
});

describe('padding-block-end', () => {
  it('supports padding-block-start and padding-block-end', () => {
    expect(transpile('div', 'padding-block-end: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'padding-block-end: inherit;'))
      .toBe('div{padding-bottom:inherit;}');
  });
});
