...
describe('margin-inline', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-inline: inherit;')).toBe(
      'html:not([dir=rtl]) div{margin-left:inherit;margin-right:inherit;}[dir=rtl] div{margin-right:inherit;margin-left:inherit;}'
    );
  });
});
...
describe('margin-inline-start', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-inline-start: inherit;')).toBe(
      'html:not([dir=rtl]) div{margin-left:inherit;}[dir=rtl] div{margin-right:inherit;}'
    );
  });
});
...
describe('margin-inline-end', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-inline-end: inherit;')).toBe(
      'html:not([dir=rtl]) div{margin-right:inherit;}[dir=rtl] div{margin-left:inherit;}'
    );
  });
});
...
describe('margin-block', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-block: inherit;')).toBe(
      'div{margin-top:inherit;margin-bottom:inherit;}'
    );
  });
});
...
describe('margin-block-start', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-block-start: inherit;')).toBe(
...
describe('margin-block-end', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'margin-block-end: inherit;')).toBe(
