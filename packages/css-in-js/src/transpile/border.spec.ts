...
describe('border-block', () => {
  it('supports border-block', () => {
    expect(transpile('div', 'border-block: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block: inherit;'))
      .toBe('div{border-top:inherit;border-bottom:inherit;}');
  });
});

describe('border-block-start', () => {
  it('supports border-block-start and border-block-end', () => {
    expect(transpile('div', 'border-block-start: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-start: inherit;'))
      .toBe('div{border-top:inherit;}');
  });
});

describe('border-block-end', () => {
  it('supports border-block-start and border-block-end', () => {
    expect(transpile('div', 'border-block-end: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-end: inherit;'))
      .toBe('div{border-bottom:inherit;}');
  });
});
...
describe('border-inline-width', () => {
  ...
  it('supports border-inline-start-width and border-inline-end-width', () => {
    expect(transpile('div', 'border-inline-width: inherit;', {
      supportedProperties: ['border-inline-start-width', 'border-inline-end-width'],
      prefix: false,
    }))
      .toBe('div{border-inline-start-width:inherit;border-inline-end-width:inherit;}');
  });
...
describe('border-block-width', () => {
  it('supports border-block-width', () => {
    expect(transpile('div', 'border-block-width: inherit;', {
  ...
  it('supports border-block-start-width and border-block-end-width', () => {
    expect(transpile('div', 'border-block-width: inherit;', {
      supportedProperties: ['border-block-start-width', 'border-block-end-width'],
      prefix: false,
    }))
      .toBe('div{border-block-start-width:inherit;border-block-end-width:inherit;}');
  });

  it('fallbacks', () => {
    expect(transpile('div', 'border-block-width: inherit;'))
      .toBe('div{border-top-width:inherit;border-bottom-width:inherit;}');
  });
});

describe('border-block-start-width', () => {
  it('supports border-block-start-width and border-block-end-width', () => {
    expect(transpile('div', 'border-block-start-width: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-start-width: inherit;'))
      .toBe('div{border-top-width:inherit;}');
  });
});

describe('border-block-end-width', () => {
  it('supports border-block-start-width and border-block-end-width', () => {
    expect(transpile('div', 'border-block-end-width: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-end-width: inherit;'))
      .toBe('div{border-bottom-width:inherit;}');
  });
});
...
describe('border-inline-style', () => {
  ...
  it('supports border-inline-start-style and border-inline-end-style', () => {
    expect(transpile('div', 'border-inline-style: inherit;', {
      supportedProperties: ['border-inline-start-style', 'border-inline-end-style'],
      prefix: false,
    }))
      .toBe('div{border-inline-start-style:inherit;border-inline-end-style:inherit;}');
  });
...
describe('border-block-style', () => {
  it('supports border-block-style', () => {
    expect(transpile('div', 'border-block-style: inherit;', {
  ...
  it('supports border-block-start-style and border-block-end-style', () => {
    expect(transpile('div', 'border-block-style: inherit;', {
      supportedProperties: ['border-block-start-style', 'border-block-end-style'],
      prefix: false,
    }))
      .toBe('div{border-block-start-style:inherit;border-block-end-style:inherit;}');
  });

  it('fallbacks', () => {
    expect(transpile('div', 'border-block-style: inherit;'))
      .toBe('div{border-top-style:inherit;border-bottom-style:inherit;}');
  });
});

describe('border-block-start-style', () => {
  it('supports border-block-start-style and border-block-end-style', () => {
    expect(transpile('div', 'border-block-start-style: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-start-style: inherit;'))
      .toBe('div{border-top-style:inherit;}');
  });
});

describe('border-block-end-style', () => {
  it('supports border-block-start-style and border-block-end-style', () => {
    expect(transpile('div', 'border-block-end-style: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-end-style: inherit;'))
      .toBe('div{border-bottom-style:inherit;}');
  });
});
...
describe('border-inline-color', () => {
  ...
  it('supports border-inline-start-color and border-inline-end-color', () => {
    expect(transpile('div', 'border-inline-color: inherit;', {
      supportedProperties: ['border-inline-start-color', 'border-inline-end-color'],
      prefix: false,
    }))
      .toBe('div{border-inline-start-color:inherit;border-inline-end-color:inherit;}');
  });
...
describe('border-block-color', () => {
  it('supports border-block-color', () => {
    expect(transpile('div', 'border-block-color: inherit;', {
  ...
  it('supports border-block-start-color and border-block-end-color', () => {
    expect(transpile('div', 'border-block-color: inherit;', {
      supportedProperties: ['border-block-start-color', 'border-block-end-color'],
      prefix: false,
    }))
      .toBe('div{border-block-start-color:inherit;border-block-end-color:inherit;}');
  });

  it('fallbacks', () => {
    expect(transpile('div', 'border-block-color: inherit;'))
      .toBe('div{border-top-color:inherit;border-bottom-color:inherit;}');
  });
});

describe('border-block-start-color', () => {
  it('supports border-block-start-color and border-block-end-color', () => {
    expect(transpile('div', 'border-block-start-color: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-start-color: inherit;'))
      .toBe('div{border-top-color:inherit;}');
  });
});

describe('border-block-end-color', () => {
  it('supports border-block-start-color and border-block-end-color', () => {
    expect(transpile('div', 'border-block-end-color: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-block-end-color: inherit;'))
      .toBe('div{border-bottom-color:inherit;}');
  });
});
