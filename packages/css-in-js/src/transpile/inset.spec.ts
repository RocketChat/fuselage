...
describe('inset', () => {
  ...
  it('supports inset-inline-start, inset-inline-end, inset-block-start, and inset-block-end', () => {
    expect(transpile('div', 'inset: inherit;', {
      supportedProperties: ['inset-inline-start', 'inset-inline-end', 'inset-block-start', 'inset-block-end'],
      prefix: false,
    }))
      .toBe('div{inset-inline-start:inherit;inset-inline-end:inherit;inset-block-start:inherit;inset-block-end:inherit;}');
  });
...
describe('inset-block', () => {
  it('supports inset-block', () => {
    expect(transpile('div', 'inset-block: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'inset-block: inherit;'))
      .toBe('div{top:inherit;bottom:inherit;}');
  });
});

describe('inset-block-start', () => {
  it('supports inset-block-start and inset-block-end', () => {
    expect(transpile('div', 'inset-block-start: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'inset-block-start: inherit;'))
      .toBe('div{top:inherit;}');
  });
});

describe('inset-block-end', () => {
  it('supports inset-block-start and inset-block-end', () => {
    expect(transpile('div', 'inset-block-end: inherit;', {
