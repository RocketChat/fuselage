...
describe('border-start-start-radius', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-start-start-radius: inherit;')).toBe(
      'html:not([dir=rtl]) div{border-top-left-radius:inherit;}[dir=rtl] div{border-top-right-radius:inherit;}'
    );
  });
});
...
describe('border-start-end-radius', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-start-end-radius: inherit;')).toBe(
      'html:not([dir=rtl]) div{border-top-right-radius:inherit;}[dir=rtl] div{border-top-left-radius:inherit;}'
    );
  });
});
...
describe('border-end-start-radius', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-end-start-radius: inherit;')).toBe(
      'html:not([dir=rtl]) div{border-bottom-left-radius:inherit;}[dir=rtl] div{border-bottom-right-radius:inherit;}'
    );
  });
});
...
describe('border-end-end-radius', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'border-end-end-radius: inherit;')).toBe(
      'html:not([dir=rtl]) div{border-bottom-right-radius:inherit;}[dir=rtl] div{border-bottom-left-radius:inherit;}'
    );
  });
});
