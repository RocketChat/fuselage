...
describe('inline-size', () => {
  it('supports inline-size', () => {
    expect(
      transpile('div', 'inline-size: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'inline-size: inherit;')).toBe(
      'div{width:inherit;}'
    );
  });
});
...
describe('block-size', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'block-size: inherit;')).toBe(
      'div{height:inherit;}'
    );
  });
});
...
describe('min-inline-size', () => {
  it('supports min-inline-size', () => {
    expect(
      transpile('div', 'min-inline-size: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'min-inline-size: inherit;')).toBe(
...
describe('min-block-size', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'min-block-size: inherit;')).toBe(
...
describe('max-inline-size', () => {
  it('supports max-inline-size', () => {
    expect(
      transpile('div', 'max-inline-size: inherit;', {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'max-inline-size: inherit;')).toBe(
...
describe('max-block-size', () => {
  ...
  it('fallbacks', () => {
    expect(transpile('div', 'max-block-size: inherit;')).toBe(
