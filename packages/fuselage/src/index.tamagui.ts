// Tamagui-only entry point — no SCSS import.
// Use this for Vite/modern bundlers that don't need the legacy SCSS pipeline.
...
export { RcxView, RcxText, RcxInteractive, RcxInteractiveText } from './primitives';
