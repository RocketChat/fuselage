...
const primary = {
  p100: new Var('primary-100', tokenColors.b100),
  p200: new Var('primary-200', tokenColors.b200),
  p300: new Var('primary-300', tokenColors.b300),
  p400: new Var('primary-400', tokenColors.b400),
  p500: new Var('primary-500', tokenColors.b500),
  p600: new Var('primary-600', tokenColors.b600),
  p700: new Var('primary-700', tokenColors.b700),
  p800: new Var('primary-800', tokenColors.b800),
  p900: new Var('primary-900', tokenColors.b900),
};
...
const success = {
  s100: new Var('success-100', tokenColors.g100),
  s200: new Var('success-200', tokenColors.g200),
  s300: new Var('success-300', tokenColors.g300),
  s400: new Var('success-400', tokenColors.g400),
  s500: new Var('success-500', tokenColors.g500),
  s600: new Var('success-600', tokenColors.g600),
  s700: new Var('success-700', tokenColors.g700),
  s800: new Var('success-800', tokenColors.g800),
  s900: new Var('success-900', tokenColors.g900),
};

const warning = {
  w100: new Var('warning-100', tokenColors.y100),
  w200: new Var('warning-200', tokenColors.y200),
  w300: new Var('warning-300', tokenColors.y300),
  w400: new Var('warning-400', tokenColors.y400),
  w500: new Var('warning-500', tokenColors.y500),
  w600: new Var('warning-600', tokenColors.y600),
  w700: new Var('warning-700', tokenColors.y700),
  w800: new Var('warning-800', tokenColors.y800),
  w900: new Var('warning-900', tokenColors.y900),
};

const danger = {
  d100: new Var('danger-100', tokenColors.r100),
  d200: new Var('danger-200', tokenColors.r200),
  d300: new Var('danger-300', tokenColors.r300),
  d400: new Var('danger-400', tokenColors.r400),
  d500: new Var('danger-500', tokenColors.r500),
  d600: new Var('danger-600', tokenColors.r600),
  d700: new Var('danger-700', tokenColors.r700),
  d800: new Var('danger-800', tokenColors.r800),
  d900: new Var('danger-900', tokenColors.r900),
};
...
export const surfaceColors = {
  ...
  'surface-overlay': neutral.n800.theme('surface-overlay'),
...
export const statusBackgroundColors = {
  'status-background-info': primary.p200.theme('status-background-info'),
...
export const statusColors = {
  'status-font-on-info': primary.p600.theme('status-font-on-info'),
...
export const badgeBackgroundColors = {
  ...
  'badge-background-level-2': primary.p500.theme('badge-background-level-2'),
  'badge-background-level-3': service1[500].theme('badge-background-level-3'),
  'badge-background-level-4': danger.d500.theme('badge-background-level-4'),
};
