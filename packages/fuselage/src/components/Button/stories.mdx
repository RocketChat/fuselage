...
<Story name='States'>
  <PropsVariationSection
    ...
    xAxis={{
      ...
      'text + icon + danger': { children: <><Icon name='circled-arrow-down' size='16' /> Button</>, danger: true },
    }}
    yAxis={{
      default: {},
...
<Story name='States of Small Variant'>
  <PropsVariationSection
    ...
    xAxis={{
      ...
      'text + icon + danger': { children: <><Icon name='circled-arrow-down' size='12' /> Button</>, danger: true },
    }}
    yAxis={{
      default: {},
      hover: { className: 'hover' },
