...
<Meta title='Sidebar.Containers/Sidebar/TopBar' parameters={{ jest: ['Sidebar/spec'] }} />
...
<Canvas>
  <Story name='Default'>
    <TopBar.Section>
        ...
        <TopBar.Actions>
            <TopBar.Action icon='phone'/>
            <TopBar.Action icon='circle-cross'/>
            <TopBar.Action icon='trash'/>
            <TopBar.Action icon='phone'/>
        </TopBar.Actions>
    </TopBar.Section>
    <TopBar.ToolBox>
