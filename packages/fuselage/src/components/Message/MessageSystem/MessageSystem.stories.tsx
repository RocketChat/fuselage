...
export const Default: StoryFn<typeof MessageSystem> = () => (
  <Box overflow='hidden'>
...
export const WithLongTopic: StoryFn<typeof MessageSystem> = () => (
  <Box overflow='hidden'>
    <MessageSystem>
      <MessageSystemLeftContainer>
        <Avatar
      ...
      <MessageSystemContainer>
        <MessageSystemBlock>
          ...
          <MessageSystemBody>
            ...
            all PRs | Testing: Automated tests passing | Performance: Optimized
            for scale
          </MessageSystemBody>
          <MessageSystemTimestamp>12:00 PM</MessageSystemTimestamp>
        </MessageSystemBlock>
