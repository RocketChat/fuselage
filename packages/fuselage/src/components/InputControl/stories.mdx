...
<Preview>
  <Story name='Types'>
    <>
      <Label position='top' text='text' style={{ margin: '0 1rem' }}>
        <InputControl type='text' />
      </Label>
      <Label position='top' text='textarea' style={{ margin: '0 1rem' }}>
        <InputControl type='textarea' rows={2} />
      </Label>
      <Label position='top' text='select' style={{ margin: '0 1rem' }}>
