import type { ComponentPropsWithoutRef, ReactNode, RefCallback } from 'react';
import {
  createContext,
  useCallback,
  useContext,
...
type LabelTypes = 'hint' | 'description' | 'error' | 'placeholder';

type FieldType = 'wrappedByLabel' | 'referencedByLabel' | 'referencedByInput';
