...
export const useSpaceProps = ({
  ...
  const spacesClassName = useCss([
    ...
    pb !== undefined && paddingBlock(getPaddingValue(mb)),
    pbs !== undefined && paddingBlockStart(getPaddingValue(mbs)),
    pbe !== undefined && paddingBlockEnd(getPaddingValue(mbe)),
    pi !== undefined && paddingInline(getPaddingValue(mi)),
    pis !== undefined && paddingInlineStart(getPaddingValue(mis)),
    pie !== undefined && paddingInlineEnd(getPaddingValue(mie)),
  ], [
