...
<Canvas>
  <Story name='Font sizes'>
    <>
      ...
      <Box fontSize='h1_new'>h1_new</Box>
      <Box fontSize='h2'>h2</Box>
      <Box fontSize='h3'>h3</Box>
      <Box fontSize='h4'>h4</Box>
      <Box fontSize='h5'>h5</Box>
      <Box fontSize='s1'>s1 * deprecated</Box>
      <Box fontSize='s2'>s2 * deprecated</Box>
      <Box fontSize='p1'>p1</Box>
      <Box fontSize='p1_new'>p1_new</Box>
      <Box fontSize='p2'>p2</Box>
      <Box fontSize='p2_new'>p2_new</Box>
