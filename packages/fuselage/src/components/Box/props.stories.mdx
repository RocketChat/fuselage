...
<Canvas>
  ...
  >
    <>
      <Box bg='font-white' />
      <Box bg='font-disabled' />
      <Box bg='font-annotation' />
      <Box bg='font-hint' />
      <Box bg='font-text' />
      <Box bg='font-title-labels' />
      <Box bg='font-danger' />
      <Box bg='font-secondary-info' />
      <Box bg='font-on-info' />
      <Box bg='font-on-success' />
      <Box bg='font-on-warning' />
      <Box bg='font-on-danger' />
      <Box bg='font-on-service-1' />
      <Box bg='font-on-service-2' />
    </>
  </Story>
</Canvas>
