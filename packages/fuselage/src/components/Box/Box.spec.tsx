...
import Box from './Box';
import * as richContentBlockStories from './richContentBlock.stories';
import * as richContentInlineStories from './richContentInline.stories';

testsFromStories(richContentBlockStories);
testsFromStories(richContentInlineStories);
