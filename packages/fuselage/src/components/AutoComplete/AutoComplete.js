...
import { Box } from '../Box';
import { Options, SelectedOptions, OptionAvatar } from './Options';
  ...
  return (
    <Container is='label' style={{ position: 'relative' }}>
      <Chip.Wrapper role='listbox'>
        <InputBox.Input onInput={(e) => setFilter(e.currentTarget.value)} onBlur={hide} onFocus={show} onKeyDown={handleKeyDown} placeholder={placeholder} style={{ order: 1, minWidth: '150px' }} mod-undecorated value={value}/>
