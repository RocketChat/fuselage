    ...
    for(const obj of graph) {
        if(isStoryBookPkg(Object.keys(obj)[0])){
            if(Object.values(obj)[0] === pkgName) {
                const result = await getReasons(pkgName, `.github/actions/test/dist/trimmed-${Object.keys(obj)[0]}-stats.json`);
                const cmp = {[Object.keys(obj)[0]]:await getComponentTitle(result, Object.keys(obj)[0])};
                overall.push(cmp);
            }
        }
    }
